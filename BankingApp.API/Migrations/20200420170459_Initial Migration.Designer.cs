...
namespace BankingApp.API.Migrations
{
    ...
    [Migration("20200420170459_Initial Migration")]
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2020, 4, 20, 20, 4, 59, 472, DateTimeKind.Local).AddTicks(7463));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("RegisteredDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 20, 20, 4, 59, 487, DateTimeKind.Local).AddTicks(2872));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("DateIssued")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 20, 20, 4, 59, 501, DateTimeKind.Local).AddTicks(8675));
