...
namespace BankingApp.API.Migrations
{
    ...
    [Migration("20200427205436_Added Roles Initial")]
    partial class AddedRolesInitial
    {
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2020, 4, 27, 23, 54, 36, 183, DateTimeKind.Local).AddTicks(6758));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("RegisteredDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 27, 23, 54, 36, 195, DateTimeKind.Local).AddTicks(9954));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "f7cd8ad7-6b94-4efc-9cb9-a00bba016354",
                            Name = "Customer"
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "4fbfad1e-b250-4b06-83b2-584ee8b8d070",
                            Name = "LoanOfficer"
                        },
                        new
                        {
                            Id = 3,
                            ConcurrencyStamp = "fdb9aaeb-3d59-403f-afc3-e726b7635012",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("DateIssued")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 27, 23, 54, 36, 226, DateTimeKind.Local).AddTicks(4283));
